...
export function Ladder() {
	...
	async function isLadderModerator() {
		...
		} else console.log("User is not a ladder moderator");
	}
	...
	async function getMatches() {
		const { data, error } = await supabase
			.from("match_history")
			.select(
				"challenger_id, opponent_id, challenger_score, opponent_score, completed, challenger_team:challenger_id(team_name), opponent_team:opponent_id(team_name)"
			)
			.eq("ladder_id", thisLadder.ladder_id)
